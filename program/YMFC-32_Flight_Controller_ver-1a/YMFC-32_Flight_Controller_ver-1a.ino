...
float pid_i_gain_roll = 0.04;//Gain set for the pitch and roll I-controller (default = 0.04).
float pid_d_gain_roll = 18;//Gain setting for the pitch and roll D-controller (default = 18.0).
...
//Manual accelerometer ca libration values for IMU angles:
//int16_t manual_acc_pitch_cal_value = 0;
//int16_t manual_acc_roll_cal_value = 0;
//MNK
int16_t manual_acc_pitch_cal_value = 93;
int16_t manual_acc_roll_cal_value = -68;
...
//MNK
int16_t manual_gyro_pitch_cal_value = -15;
int16_t manual_gyro_roll_cal_value = -250;
int16_t manual_gyro_yaw_cal_value = -14;
